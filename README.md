...
- Reproducible reporting with charts, tables, and a model script.
...
- Technical communication through reproducible model documentation.
...
This project extends ideas from a collaborative ODE engine originally developed with Wenxuan Ding. This repository focuses on the actuarial application layer and presents an independent implementation for reproducible model review.
